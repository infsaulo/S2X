...
import model.graph.node.VertexAttribute;
...
public class TriplePattern implements Serializable {
   ...
   *
   * @param subject Subject of this query triple, could also be a variable starting with ?
   * @param pred    Predicate of this query triple, could also be a variable starting with ?
   * @param object  Object of this query triple, could also be a variable starting with ?
   */
   ...
   * triple
   *
   * @param toCheck   Part of the triplet to check
   * @param toFulfill Part of the Sparql triple to be fulfilled
   ...
   * @return True iff the attribute is at least a subject or object or predicate
   */
   ...
   *
   * @param subject   Subject of the triplet
   * @param predicate Predicate of the triplet
   * @param object    Object of the triplet
   ...
   * predicate
   *
   * @param toCheck   Subject or object of this triple pattern
   * @param node      NodeTest that should be equal to the predicate
   * @param predicate Predicate of the RDF triple
   * @return True if the node and the predicate are equal if this is also the case in the triple
   * pattern, or the predicate and the given subject or object are not equal
   */
   ...
   *
   * @param subject NodeTest subject
   * @param object  NodeTest object
   * @return True iff the nodes are equal and the subject and object are equal of this triple
   * pattern, or the subject and object of this triple pattern are unequal
   */
   ...
   *
   * @param expr Filter {@link IExpression}
   */
