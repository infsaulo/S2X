...
public class CompositeKeyNodeAttr extends CompositeKey {
   ...
   *
   * @param triplePattern see {@link TriplePattern#getStringRepresentation()}
   * @param position      Position which the node is in the result
   ...
   * Create a new {@link CompositeKey} with node attribute.
   *
   * @param key           The key to add the attribute
   * @param nodeAttribute Attribute of the node
   */
