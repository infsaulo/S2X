...
public class IntermediateResultsModel {
   ...
   */
  private static Map<Integer, RDDVariablePair> results = new HashMap<Integer, RDDVariablePair>();

  /**
   * Singleton instance
   */
  private static volatile IntermediateResultsModel instance;
   ...
   *
   * @return One result of the map or throws an UnsupportedOperationException if more than one
   * result is in the map
   */
