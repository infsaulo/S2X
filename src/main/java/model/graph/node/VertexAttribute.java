...
public class VertexAttribute implements VertexInterface {
   ...
   *
   * @param attribute RDF attribute of this node
   */
   ...
   *
   * @param map   The map where the results are added to
   * @param toAdd Results to add
   */
   ...
   * toDelete map
   *
   * @param toClean  Map to clean
   * @param toDelete Map with results of nodes that should be deleted
   */
   ...
   *
   * @param results Results to search node attributes
   ...
   *
   * @param key {@link CompositeKey} to delete
   */
  ...
  public String toString() {
    ...
    result.append("NodeTest [nodeAttribute=" + nodeAttribute
   ...
   *
   * @param toClean  Map to remove nodes
   * @param nodeAttr The node attribute of the node that should be removed
   */
   ...
   * attribute
   *
   * @param matchSet Set where the results should be removed
   */
