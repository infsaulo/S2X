...
import parser.query.op.SparkBGP;
import parser.query.op.SparkDistinct;
import parser.query.op.SparkFilter;
import parser.query.op.SparkLeftJoin;
import parser.query.op.SparkOp;
import parser.query.op.SparkOrderBy;
import parser.query.op.SparkProjection;
import parser.query.op.SparkSlice;
import parser.query.op.SparkUnion;
...
public class AlgebraTranslator extends OpVisitorBase {
   ...
   *
   * @param prefixes All prefixes to use
   */
   ...
   * directly
   *
   * @param expr Expressions that should be added
   */
   ...
   *
   * @param expr Expressions to execute
   */
