package sparql.message.datatype;
 ...
 */
public class AdjacentNode implements Serializable {

  private static final long serialVersionUID = -1353083333130353150L;
   ...
   *
   * @param Id        NodeTest Id of the child or parent node
   * @param attribute Attribute of the child or parent node
   * @param isParent  True iff the node is the parent of the other node, false if it is the child
   */
