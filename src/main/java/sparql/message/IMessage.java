...
public interface IMessage extends Serializable {
   ...
   *
   * @param toAdd Set of {@link ResultValue}s to add
   */
   ...
   * @throws UnsupportedOperationException Thrown whenever this operation is called on an object
   *                                       which is not an instance of {@link ResultMessage}
   */
